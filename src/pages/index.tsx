  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless car booking with B2C Car Sharing v2. Empowering individual customers and simplifying operations with centralized dashboards. Your journey, just a click away."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless car booking with B2C Car Sharing v2. Empowering individual customers and simplifying operations with centralized dashboards. Your journey, just a click away.`}
            </Text>
            <Box
